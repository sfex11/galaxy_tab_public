# headland-coverage-path-planning
...
중첩 폴리곤+부드러운 회전 접근이 코너 완전 커버에 구조적으로 불충분함을 진단하고, 폴리곤 코너를 후진 회전 가능 형태로 수정하는 구체적 경로를 제공한다. 이 엔티티의 정의를 '기하 완전성과 운동학 제약 간 조정 문제'로 구체화한다.
