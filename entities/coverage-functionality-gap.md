...
- [[sources/2026-04-30-restestbench-a-benchmark-for-evaluating-the-effect.md|RESTestBench: A Benchmark for Evaluating the Effectiveness o]]
...
RESTestBench(테스트 적합성), SWE-Gate(패치 수용)에 이어 디컴파일(정보 보존)이라는 세 번째 도메인에서 측정 프록시와 실제 목표의 단절을 확인시킨다. 프록시 단절의 도메인 불변성에 대한 결정적 근거가 된다.
