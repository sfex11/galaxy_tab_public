...
- → [[sources/2026-04-29-governing-what-you-cannot-observe-adaptive-runtime]]: 두 논문 모두 자율 에이전트가 고신뢰 도메인에서 작동할 때 발생할 수 있는 위험(행동 드리프트, 보안 위협)을 통제하기 위해, 런타임 관측 및 구조적 제약을 통해 에이전트의 안전성을 확보하는 거버넌스 접근법을 다룬다.
