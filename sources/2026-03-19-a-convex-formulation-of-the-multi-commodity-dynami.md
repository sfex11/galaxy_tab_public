...
이 연구는 전통적인 교통공학과 최적화 이론의 교차점에 위치한다. 최근 AI/ML 기반 교통 최적화 연구가 활발하지만, 본 논문은 수학적 정식화를 통한 정확한 해법에 초점을 맞추고 있어 강화학습 기반 접근법과는 상호 보완적 관계에 있다. 특히 [[reinforcement-learning]] 기반 교통 제어 연구에서 볼록 정식화가 제공하는 이론적 최적해를 벤치마크로 활용할 수 있다.
