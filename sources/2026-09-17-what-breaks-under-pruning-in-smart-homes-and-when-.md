...
- → [[sources/2026-09-17-justfit-200k-token-llm-serving-on-a-24-gib-laptop-]]: 노트북·스마트홈 같은 저사양 배포 환경에서 KV 압축·상태 관리와 프루닝이 능력 저하와 맺는 트레이드오프를 다룬다.
