...
**출처**: arXiv  
**날짜**: 2026-04-29  
**링크**: http://arxiv.org/abs/2604.24658v1
...
- → [[sources/2026-04-30-pythia-toward-predictability-driven-agent-native-l]]: 두 논문 모두 기존의 인간 중심적이거나 전통적인 LLM 서빙 방식을 대체하는 '에이전트 네이티브'라는 새로운 패러다임을 제시하며, 에이전트의 구조적 특성에 맞춘 연구 산출물 및 시스템 설계의 필요성을 주장한다.

---
**관련**: [[entities/training-process-gaming.md|training process gaming]]

---
**관련**: [[entities/constrained-exploration.md|constrained exploration]]
...
---
**관련**: [[entities/interpretive-vs-structural-enforcement.md|interpretive vs structural enforcement]]
