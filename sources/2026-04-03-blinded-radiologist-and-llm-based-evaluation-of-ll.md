...
[[multilingual-nlp]] 개념과 직접적으로 관련되며, LLM의 다국어 처리 능력을 의료 보고서라는 고위험 도메인에서 검증한다는 점에서 차별화된다. [[llm-benchmark]] 관점에서는 LLM-as-a-judge 패러다임의 도메인 특화 적용 사례로 볼 수 있다. 또한 [[medical-ai]]의 확장으로서, 진단이 아닌 의료 커뮤니케이션 영역에서의 LLM 활용을 다룬다. [[machine-translation]] 개념과도 연결되며, 전문 도메인 번역에서의 LLM 성능을 인간 전문가와 직접 비교한다는 점이 핵심이다.
