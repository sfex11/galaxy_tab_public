...
**출처**: arXiv  
**날짜**: 2026-09-17  
**링크**: http://arxiv.org/abs/2609.17474v1
...
- → [[sources/2026-09-18-a-zeroth-order-paradigm-for-llm-preference-alignme]]: 증류의 교사 편향과 정렬의 우도 이동이라는 훈련 신호의 체계적 왜곡을, 캘리브레이션 결합과 비교 기반 제로스-오더 방법으로 각각 교정한다.
