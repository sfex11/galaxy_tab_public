...
**출처**: arXiv  
**날짜**: 2026-07-23  
**링크**: http://arxiv.org/abs/2607.19223v1
...
- → [[sources/2026-07-24-pyrodash-cost-efficient-token-level-small-large-la]]: 두 논문 모두 대규모 언어 모델의 추론 비용과 속도를 최적화하기 위해 작은 모델과 큰 모델을 협력적으로 활용하는 기법을 제안함.
