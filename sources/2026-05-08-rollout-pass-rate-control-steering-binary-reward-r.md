...
**출처**: arXiv  
**날짜**: 2026-05-08  
**링크**: http://arxiv.org/abs/2605.05112v1
...
- → [[sources/2026-05-06-scprm-a-schema-aware-cumulative-process-reward-mod]]: 두 논문 모두 강화학습에서의 보상 신호 설계 문제를 다루며, 하나는 중간 단계 보상의 위험 보상 효과를, 다른 하나는 이진 보상에서의 패스율 제어를 해결한다.
...
---
**관련**: [[entities/process-control-architecture.md|process control architecture]]
