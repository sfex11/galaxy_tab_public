...
**출처**: arXiv  
**날짜**: 2026-09-23  
**링크**: http://arxiv.org/abs/2609.24847v1
...
- → [[sources/2026-09-24-flash-dllm-io-aware-kv-caching-and-parallel-decodi]]: 메모리·연산 제약 하의 LLM 추론 가속이라는 동일 문제의식 아래 추측 디코딩의 런타임 적응 실행과 KV 캐싱·병렬 디코딩의 IO 인지 공동 설계라는 상호 보완적 기법을 제시한다.
