...
이 연구는 기존 Wiki의 여러 축과 교차한다. [[concepts/autonomous-driving.md|autonomous driving]] 및 [[concepts/autonomous-driving-perception.md|autonomous driving perception]] 개념과 직접적으로 연결되며, 레이더 인식을 다룬 AdaRadar 연구([[concepts/radar-perception.md|radar perception]])와 센서 데이터 처리 관점에서 상보적이다. Graph Attention Network 구조는 [[concepts/transformer.md|transformer]] 엔티티의 어텐션 메커니즘 확장으로 볼 수 있으며, 멀티모달 센서 융합은 [[concepts/multimodal-learning.md|multimodal learning]]의 인식 도메인 적용 사례이다. 또한 궤적 예측 측면에서 [[concepts/trajectory-prediction.md|trajectory prediction]], 센서 데이터 압축 측면에서 [[concepts/data-compression.md|data compression]] 개념과도 관련된다. Fail2Drive 벤치마크가 자율주행의 일반화 실패를 평가했다면, LEO는 인식 단계에서의 견고성 향상에 초점을 맞춘다.
...
---
**관련**: [[entities/graph-rag.md|graph rag]]

---
**관련**: [[concepts/sensor-fusion.md|sensor fusion]]
...
---
**관련**: [[concepts/object-detection.md|object detection]]
