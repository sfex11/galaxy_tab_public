...
**출처**: arXiv  
**날짜**: 2026-06-03  
**링크**: http://arxiv.org/abs/2606.02569v1
...
- → [[sources/2026-06-03-protoada-prototype-guided-adaptive-adapter-expansi]]: 두 논문 모두 멀티모달 대형 언어 모델(MLLM)의 성능 및 효율성을 개선하는 것을 목표로 하며, 전자는 비디오 입력의 시각적 중복성을 해결하고 후자는 지속적 학습 시의 파괴적 망각을 해결합니다.
