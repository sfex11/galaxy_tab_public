...
기존 연구들이 LLM의 보정(calibration)이나 불확실성 정량화에 초점을 맞춘 반면, 본 논문은 신뢰도가 실제로 모델 행동의 **원인**인지를 실험적으로 규명한다는 점에서 차별화된다. 이는 [[reinforcement-learning]]에서의 보상 신호와 유사하게, 내부 신뢰도가 일종의 자기 참조적 피드백 루프로 기능할 가능성을 시사한다.
