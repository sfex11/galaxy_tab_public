...
**출처**: arXiv  
**날짜**: 2026-05-19  
**링크**: http://arxiv.org/abs/2605.16142v1
...
- → [[sources/2026-05-21-what-do-evolutionary-coding-agents-evolve]]: 두 논문 모두 피드백 신호를 활용해 LLM이 반복적으로 코드를 생성·수정하는 과정의 메커니즘을 분석한다.
