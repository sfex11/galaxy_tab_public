...
### 기존 Wiki와의 관계
- **[[metacognition]]**: 이전 연구에서 LLM의 신뢰도 기반 의사결정을 다뤘으나, 본 논문은 멀티모달 에이전트의 도구 사용 맥락으로 메타인지를 확장한다.
- **[[agentic-vlm]]**: 에이전틱 VLM의 핵심 한계인 도구 남용 문제를 직접 해결하며, SpecEyes 등 기존 효율화 연구와 보완 관계에 있다.
- **[[tool-use]]**: TraceSafe의 가드레일 평가와 달리, 도구 호출 자체의 필요성 판단에 초점을 맞춘다.
- **[[reasoning-shift]]**: 맥락에 따라 추론 전략을 전환하는 문제와 밀접하게 연결되며, 도구 호출 여부 결정이 일종의 추론 전환이다.
