...
**출처**: arXiv  
**날짜**: 2026-09-17  
**링크**: http://arxiv.org/abs/2609.17516v1
...
- → [[sources/2026-09-17-encp-episode-normalized-conformal-prediction-for-v]]: 컨펌럴 예측 기반 불확실성 추정과 자기 질문 기반 기각이라는 상이한 기법으로 '근거가 약할 때 안전하게 중단하라'는 선택적 위험 관리를 구현한다.
