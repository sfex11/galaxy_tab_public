...
- **[[representation-steering]]**: 본 논문의 직접적 연구 대상. 기존 개념 문서에 이미 2026-04-11 동일 논문의 이전 버전이 등록되어 있으며, 이번 v1 분석이 메커니즘 수준의 설명을 추가한다.
- **[[mechanistic-interpretability]]**: activation patching을 활용한 인과적 분석 방법론으로, 기존 개념과 직결된다.
- **[[activation-patching]]**: 본 논문이 기존 단일 토큰 patching을 **multi-token**으로 확장한 점이 방법론적 기여이다.
- **[[llm-alignment]]**: steering vector는 모델 정렬 기법의 일종으로, 안전성(refusal) 조정과 직접 연결된다.
- **[[ai-safety]]**: refusal 메커니즘의 이해는 guardrail 설계에 핵심적 시사점을 제공한다.
