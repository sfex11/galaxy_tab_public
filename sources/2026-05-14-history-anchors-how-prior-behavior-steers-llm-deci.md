...
**출처**: arXiv  
**날짜**: 2026-05-14  
**링크**: http://arxiv.org/abs/2605.13825v1
...
- → [[sources/2026-05-14-good-agentic-friends-do-not-just-give-verbal-advic]]: 전자가 다중 에이전트 간의 새로운 구조적 협력 방식을 제안하는 반면, 후자는 에이전트의 과거 행동 로그가 미치는 안전성 위험을 경고하여, 에이전트 시스템의 상호작용 메커니즘과 그 위험성을 상호 보완적으로 조명합니다.
