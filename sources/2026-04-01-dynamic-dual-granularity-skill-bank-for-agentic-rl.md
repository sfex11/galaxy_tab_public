...
이 연구는 [[concepts/reinforcement-learning.md|reinforcement learning]]의 에이전틱 확장으로, LLM Agent가 환경과 상호작용하며 스킬을 축적하는 패러다임을 제시한다. [[entities/llm-agent.md|llm agent]] 연구에서 도구 사용(tool-use)과 메타인지(metacognition) 능력이 강조되어 왔는데, D2Skill의 이중 세분화 접근은 [[concepts/metacognition.md|metacognition]]의 '언제 어떤 스킬을 적용할지 판단'하는 메타 수준 의사결정과 직접 연결된다. 또한 [[concepts/hierarchical-representation.md|hierarchical representation]]의 다층적 추상화 개념을 스킬 관리에 적용한 것으로 볼 수 있다.

스킬 뱅크의 동적 갱신 메커니즘은 [[concepts/transfer-learning.md|transfer learning]]과 [[concepts/meta-learning.md|meta learning]]에서 다뤄온 경험 재사용 문제의 실용적 해법이며, Android Coach의 온라인 에이전틱 학습 효율화 연구와도 상호 보완적이다.
...
---
**관련**: [[concepts/granularity-fragmentation.md|granularity fragmentation]]
