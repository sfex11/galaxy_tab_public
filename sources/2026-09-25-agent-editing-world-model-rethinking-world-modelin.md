...
- → [[sources/2026-09-24-cliffcompaction-cost-efficient-compaction-for-long]]: 장기 과업에서 오염된 에이전트 상태(낡은 계획, 누적 컨텍스트)의 정제를 세계 모델 개입과 자동 압축으로 각각 수행하는 에이전트 상태 관리 연구로 연결된다.
