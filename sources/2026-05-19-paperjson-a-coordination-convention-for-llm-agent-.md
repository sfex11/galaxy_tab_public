...
- → [[sources/2026-05-21-less-back-and-forth-a-comparative-study-of-structu]]: 두 논문 모두 LLM 에이전트의 입력을 구조화하여 정보 추출 품질을 높이고 상호작용 비용을 줄이는 접근을 공유한다.
