...
**출처**: arXiv  
**날짜**: 2026-07-31  
**링크**: http://arxiv.org/abs/2607.27146v1
...
- → [[sources/2026-07-31-specfirst-behavioral-specification-elicitation-as-]]: 둘 다 기존 코드베이스 없이 자연어 명세만으로 프로그램을 처음부터 합성하는 에이전트 기반 프로그램 생성 문제를 다룬다.
